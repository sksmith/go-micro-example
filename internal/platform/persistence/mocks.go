...
// MockConn satisfies Conn. It exists primarily as the embed for
...
//
// Call counters are deliberately *not* tracked here — persistence.MockConn is
...
// MockTransaction satisfies Transaction (which is Conn +
